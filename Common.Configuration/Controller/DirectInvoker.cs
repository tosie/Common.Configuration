...
namespace Common.Configuration {
    ...
    public static class DirectInvoker {
        ...
        public static object InvokeDirect(MethodInfo method, object instance, params object[] parameters) {
            ...
            // Case 1: method_parameters > 0
            //           - parameters must be != null
            //           - parameters.Length must be == method_parameters
            // Case 2: method_parameters == 0
        ...
        private static void createAssembly() {
            if (asmBuilder == null) {
                asmBuilder = Thread.GetDomain().DefineDynamicAssembly(new AssemblyName("direct_invoker_assembly"), AssemblyBuilderAccess.Run);
